(in-package :cl-user)
(defpackage caveweb.view
  (:use :cl)
  (:import-from :caveweb.config
                :*template-directory*)
...
(import '(caveweb.config:config
          caveweb.config:appenv
          caveweb.config:developmentp
          caveweb.config:productionp
          caveman2:url-for)
